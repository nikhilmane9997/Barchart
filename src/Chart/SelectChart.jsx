...
import VerifiedData from './Simpledata.json'
import {
  Dropdown,
  DropdownToggle,
  DropdownMenu,
      ...
      {two} */}
        <form className={classes.root} noValidate autoComplete="off">
          ...
          <Button
            variant="contained"
            color="secondary"
            style={{ zIndex: 1, cursor: "pointer", position: "relative", top: 15 }}
            onClick={() => {
  ...
  // ["Card/Internet", 195, 71, 110, 42, 40, 52],
        ...
        <Chart
          ...
          data={[
            ...
            ["Off Balance Sheet", labeldataoffset, twosoffset, threeoffset, fouroffset, fiveoffset, sixoffset],
            ["Forex Transaction", labeldataForex, twosForex, threeForex, fourForex, fiveForex, fiveForex],
            ["Card/Internet", labeldataCard, twosCard, threeCard, fourCard, fiveCard, fiveCard],
            ["Deposits", labeldataDeposits, twosDeposits, threeDeposits, fourDeposits, fiveDeposits, fiveDeposits],
